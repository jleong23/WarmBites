  ...
  <div class="flex flex-col max-w-screen-lg container py-20">
    ...
    <div>
      ...
      <ul class="flex flex-col text-lg gap-4">
        <li v-for="(instruction, index) in data?.instructions" class="flex gap-2 text-bold" :key="index">
          <span class="flex items-center justify-center bg-yellow-500 w-7 h-7 rounded-full text-white text-sm">
            {{ index + 1 }}
          </span>
